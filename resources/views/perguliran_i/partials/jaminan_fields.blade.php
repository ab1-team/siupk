        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group input-group-static my-3">
                    ...
                    class="form-control" style="border: 1px solid #d4d4d4; border-radius: 6px;">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="input-group input-group-static my-3">
                    ...
                    <input autocomplete="off" type="text" name="data_jaminan[alamat]" value="{{ isset($jaminan['alamat']) ? $jaminan['alamat'] : '' }}" id="alamat" class="form-control" style="border: 1px solid #d4d4d4; border-radius: 6px;">
            ...
            <div class="col-md-4">
                <div class="input-group input-group-static my-3">
                    ...
                    <input autocomplete="off" type="text" name="data_jaminan[luas]" value="{{ isset($jaminan['luas']) ? $jaminan['luas'] : '' }}" id="luas" class="form-control" style="border: 1px solid #d4d4d4; border-radius: 6px;">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group input-group-static my-3">
                    ...
                    <input autocomplete="off" type="text" name="data_jaminan[nomor]" value="{{ isset($jaminan['nomor']) ? $jaminan['nomor'] : '' }}" id="nomor" class="form-control" style="border: 1px solid #d4d4d4; border-radius: 6px;">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="input-group input-group-static my-3">
                    ...
                    <input autocomplete="off" type="text" name="data_jaminan[nopol]" value="{{ isset($jaminan['nopol']) ? $jaminan['nopol'] : '' }}" id="nopol" class="form-control" style="border: 1px solid #d4d4d4; border-radius: 6px;">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="input-group input-group-static my-3">
                    ...
                    id="nama_kuitansi_penerbit" class="form-control" style="border: 1px solid #d4d4d4; border-radius: 6px;">
