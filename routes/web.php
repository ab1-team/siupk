...
Route::post('/pengaturan/whatsapp/send_bulk', [SopController::class, 'send_bulk_whatsapp'])->middleware('auth');
...
Route::get('/generate_simpanan', [GenerateBungaController::class, 'index'])->middleware('auth')->name('generate.simpanan');
